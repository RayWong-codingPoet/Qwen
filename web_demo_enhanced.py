...
with gr.Blocks() as demo:
    ...
    submitBtn.click(predict,
                    [user_input, system_prompt, chatbot, max_length, top_p, temperature, history, past_key_values],
                    [chatbot, history, past_key_values], show_progress=True)
    submitBtn.click(reset_user_input, [], [user_input])

    emptyBtn.click(reset_state, outputs=[chatbot, history, past_key_values], show_progress=True)

demo.queue().launch(share=False, debug=True, server_name="0.0.0.0", inbrowser=True,
                    auth=("adminandmin", "vnljksadfu8oilrk32%@vsdaf#"))
